...
Because the terminal block plugs must be bought separately, it may be better to buy the receptacles too and solder them manually after manufacture.  Alternatively, you could use one of the receptacle clones from JLCPCB's inventory and hope they are sufficiently compatible with the separately purchased plugs.
